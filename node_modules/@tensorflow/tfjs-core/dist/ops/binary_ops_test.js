...
test_util_1.describeWithFlags('prelu', test_util_1.ALL_ENVS, function () {
    it('basic', function () {
...
test_util_1.describeWithFlags('maximum', test_util_1.ALL_ENVS, function () {
...
test_util_1.describeWithFlags('squaredDifference', test_util_1.ALL_ENVS, function () {
    it('float32 and float32', function () {
        var a = tf.tensor1d([0.5, 3, -0.1, -4]);
        var b = tf.tensor1d([0.2, 0.4, 0.25, 0.15]);
...
test_util_1.describeWithFlags('minimum', test_util_1.ALL_ENVS, function () {
    it('float32 and float32', function () {
        var a = tf.tensor1d([0.5, 3, -0.1, -4]);
        var b = tf.tensor1d([0.2, 0.4, 0.25, 0.15]);
...
test_util_1.describeWithFlags('mod', test_util_1.ALL_ENVS, function () {
    it('float32 and float32', function () {
        var a = tf.tensor1d([0.5, 3, -0.1, -4]);
        var b = tf.tensor1d([0.2, 0.4, 0.25, 0.15]);
...
test_util_1.describeWithFlags('atan2', test_util_1.ALL_ENVS, function () {
